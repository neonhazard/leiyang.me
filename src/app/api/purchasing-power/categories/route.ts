...
import { getCategoryBreakdown } from '@/lib/cpi';
...
export async function GET(req: NextRequest) {
  ...
  const breakdown = await getCategoryBreakdown(amount, fromYear, toYear);
  return NextResponse.json({ amount, fromYear, toYear, categories: breakdown });
}
